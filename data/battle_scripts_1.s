...
gBattleScriptsForMoveEffects::
	...
	.4byte BattleScript_EffectDefenseUpUserAlly		  @ EFFECT_DEFENSE_UP_USER_ALLY
	.4byte BattleScript_EffectHit                     @ EFFECT_SPACIAL_REND
	...
	.4byte BattleScript_EffectBounce                  @ EFFECT_BOUNCE
	.4byte BattleScript_EffectThunderclap			  @ EFFECT_THUNDERCLAP
	.4byte BattleScript_EffectConsecration			  @ EFFECT_CONSECRATION
	.4byte BattleScript_EffectHit					  @ EFFECT_ALLURE
	.4byte BattleScript_EffectHit					  @ EFFECT_WILD_RUSH
	.4byte BattleScript_EffectHit					  @ EFFECT_REQUIEM

BattleScript_EffectThunderclap::
	@ DecideTurn
	jumpifstatus2 BS_ATTACKER, STATUS2_MULTIPLETURNS, BattleScript_TwoTurnMovesSecondTurn
	jumpifword CMP_COMMON_BITS, gHitMarker, HITMARKER_NO_ATTACKSTRING, BattleScript_TwoTurnMovesSecondTurn
	setbyte sTWOTURN_STRINGID, B_MSG_TURN1_THUNDERCLAP
	call BattleScript_FirstChargingTurnThunderclap
	jumpifnoholdeffect BS_ATTACKER, HOLD_EFFECT_POWER_HERB, BattleScript_MoveEnd
	call BattleScript_PowerHerbActivation
	goto BattleScript_TwoTurnMovesSecondTurn

BattleScript_FirstChargingTurnThunderclap::
	attackcanceler
...
BattleScript_EffectDefenseUpUserAlly:
	jumpifnoally BS_ATTACKER, BattleScript_EffectDefenseUp
	attackcanceler
	attackstring
	ppreduce
...
BattleScript_EffectConsecration:
	setmoveeffect MOVE_EFFECT_CONSECRATION | MOVE_EFFECT_AFFECTS_USER
	goto BattleScript_EffectHit
...
BattleScript_MoveEffectConsecration::
	tryfaintmon BS_TARGET
	copybyte sBATTLER, sSAVED_BATTLER
	printstring STRINGID_BURSTINGFLAMESHIT
	waitmessage B_WAIT_TIME_LONG
...
BattleScript_EffectSleep::
	...
	jumpifability BS_TARGET_SIDE, ABILITY_LUNAR_GUARDIAN, BattleScript_LunarGuardianProtects
...
BattleScript_LunarGuardianProtectsRet::
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	printstring STRINGID_LUNARGUARDIANPROTECTED
	waitmessage B_WAIT_TIME_LONG
	return

BattleScript_LunarGuardianProtects:
	call BattleScript_LunarGuardianProtectsRet
	orhalfword gMoveResultFlags, MOVE_RESULT_FAILED
	goto BattleScript_MoveEnd
...
BattleScript_EffectConfuse:
	...
	jumpifability BS_TARGET, ABILITY_UNBREAKABLE, BattleScript_OwnTempoPrevents
	jumpifsubstituteblocks BattleScript_ButItFailed
...
BattleScript_EffectTripleKick::
	...
	jumpifmove MOVE_CELESTIAL_FIRE BS_TripleAxel
...
BattleScript_EffectSemiInvulnerable::
	...
	jumpifmove MOVE_GRAND_STARFALL, BattleScript_FirstTurnGrandStarfall
...
BattleScript_FirstTurnGrandStarfall::
	setbyte sTWOTURN_STRINGID, B_MSG_TURN1_GRAND_STARFALL
	goto BattleScript_FirstTurnSemiInvulnerable
...
BattleScript_FaintTarget::
	...
	tryactivatewildrush BS_ATTACKER
	tryactivatesoulheart
...
BattleScript_GulpMissileGulping::
	...
	jumpifability BS_ATTACKER, ABILITY_BIG_PECKS, BattleScript_GulpMissileNoSecondEffectGulping
...
BattleScript_EarlyBirdEnds::
	pause 3
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	printstring STRINGID_EARLYBIRDENDS
	waitmessage B_WAIT_TIME_LONG
	end2
...
BattleScript_RequiemSetUp::
	setrequiem BS_ATTACKER
	printstring STRINGID_EMPTYSTRING3
	waitmessage 1
	playanimation BS_ATTACKER, B_ANIM_REQUIEM_SETUP, NULL
	printstring STRINGID_PKMNSINGS
	waitmessage B_WAIT_TIME_LONG
	end3

BattleScript_RequiemParalysis::
	setbyte cMULTISTRING_CHOOSER, 0
	copybyte gEffectBattler, gBattlerAttacker
...
BattleScript_PowderMoveNoEffect::
	...
	jumpifability BS_TARGET, ABILITY_WATER_VEIL, BattleScript_PowderMoveNoEffectOvercoat
...
BattleScript_RoyalHoneyActivates::
	call BattleScript_AbilityHpHeal
	end3
...
.if B_UPDATED_INTIMIDATE >= GEN_8
	...
	jumpifability BS_TARGET, ABILITY_INNER_FLAME, BattleScript_IntimidatePrevented
	jumpifability BS_TARGET, ABILITY_INNER_SPARK, BattleScript_IntimidatePrevented
	jumpifability BS_TARGET, ABILITY_INNER_WATER, BattleScript_IntimidatePrevented
	jumpifability BS_TARGET, ABILITY_SCRAPPY, BattleScript_IntimidatePrevented
	jumpifability BS_TARGET, ABILITY_OWN_TEMPO, BattleScript_IntimidatePrevented
	jumpifability BS_TARGET, ABILITY_OBLIVIOUS, BattleScript_IntimidatePrevented
	jumpifability BS_TARGET, ABILITY_UNBREAKABLE, BattleScript_IntimidatePrevented
.endif
...
BattleScript_WildRushRaisesStat::
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_WildRushRaisesSpeedEnd
	jumpifbyte CMP_GREATER_THAN, cMULTISTRING_CHOOSER, B_MSG_DEFENDER_STAT_ROSE, BattleScript_WildRushRaisesSpeedEnd
	setgraphicalstatchangevalues
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_WildRushRaisesSpeedEnd:
	return
...
BattleScript_LunarGuardianActivates::
	setbyte gBattleCommunication, 0
	setbyte gBattleCommunication + 1, 0
BattleScript_LunarGuardian_TryCureSleep:
	jumpifstatus BS_TARGET, STATUS1_SLEEP | STATUS3_YAWN, BattleScript_LunarGuardianCureSleep
	goto BattleScript_LunarGuardianLoopIncrement
BattleScript_LunarGuardianCureSleep:
	jumpifbyte CMP_NOT_EQUAL, gBattleCommunication + 1, 0x0, BattleScript_LunarGuardianCureSleepNoPopUp
	call BattleScript_AbilityPopUp
	setbyte gBattleCommunication + 1, 1
BattleScript_LunarGuardianCureSleepNoPopUp: @ Only show Lunar Guardian pop up once if it cures two mons
	printfromtable gSwitchInAbilityStringIds
	waitmessage B_WAIT_TIME_LONG
	curestatus BS_TARGET
	updatestatusicon BS_TARGET
BattleScript_LunarGuardianLoopIncrement:
	jumpifbyte CMP_NOT_EQUAL, gBattleCommunication, 0x0, BattleScript_LunarGuardianEnd
	addbyte gBattleCommunication, 1
	jumpifnoally BS_TARGET, BattleScript_LunarGuardianEnd
	setallytonexttarget BattleScript_LunarGuardian_TryCureSleep
	goto BattleScript_LunarGuardianEnd
BattleScript_LunarGuardianEnd:
	end3
...
BattleScript_SoulSiphonEffect::
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	tryhealquarterhealth BS_ATTACKER, BattleScript_SoulSiphonEffect_NothingToHeal
	healthbarupdate BS_ATTACKER
	datahpupdate BS_ATTACKER
	printstring STRINGID_ATTACKERREGAINEDHEALTH
	waitmessage B_WAIT_TIME_LONG
BattleScript_SoulSiphonEffect_NothingToHeal:
    return
...
BattleScript_UnbreakableActivates::
copybyte gBattlerAbility, gEffectBattler
copybyte gBattlerAttacker, gBattlerTarget
call BattleScript_AbilityPopUp
	waitmessage B_WAIT_TIME_LONG
	...
	setstatchanger STAT_DEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | MOVE_EFFECT_CERTAIN, BattleScript_UnbreakableSpDefAnim
	jumpifstat BS_ATTACKER, CMP_EQUAL, STAT_SPDEF, MAX_STAT_STAGE, BattleScript_UnbreakableSpDefAnim
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_UnbreakableSpDefAnim:
	playstatchangeanimation BS_ATTACKER, BIT_DEF, STAT_CHANGE_CANT_PREVENT 
	setstatchanger STAT_SPDEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | MOVE_EFFECT_CERTAIN, BattleScript_UnbreakableActivatesEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_UnbreakableActivatesEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_UnbreakableActivatesEnd:
	return
...
BattleScript_BerserkGeneRet_TryConfuse:
	...
	jumpifability BS_SCRIPTING, ABILITY_UNBREAKABLE, BattleScript_BerserkGeneRet_OwnTempoPrevents
...
BattleScript_SpaceDistortionActivated::
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	printstring STRINGID_SPACEDISTORTIONACTIVATED
	waitmessage B_WAIT_TIME_LONG
	end3

BattleScript_LorentzActivated::
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	printstring STRINGID_PKMNLEVITATEDONELECTROMAGNETISM
	waitmessage B_WAIT_TIME_LONG
...
BattleScript_TimeManipulatorActivates::
	showabilitypopup BS_ATTACKER
	pause B_WAIT_TIME_LONG
	destroyabilitypopup
	setbyte gBattlerTarget, 0
BattleScript_TimeManipulatorLoop:
	jumpifbyteequal gBattlerTarget, gBattlerAttacker, BattleScript_TimeManipulatorLoopIncrement
	jumpiftargetally BattleScript_TimeManipulatorLoopIncrement
	jumpifabsent BS_TARGET, BattleScript_TimeManipulatorLoopIncrement
	jumpifstatus2 BS_TARGET, STATUS2_SUBSTITUTE, BattleScript_TimeManipulatorLoopIncrement
	jumpifability BS_TARGET, ABILITY_OWN_TEMPO, BattleScript_TimeManipulatorPrevented
	jumpifability BS_TARGET, ABILITY_OBLIVIOUS, BattleScript_TimeManipulatorPrevented
	jumpifability BS_TARGET, ABILITY_UNBREAKABLE, BattleScript_TimeManipulatorPrevented
BattleScript_TimeManipulatorEffect:
	copybyte sBATTLER, gBattlerAttacker
	statbuffchange STAT_CHANGE_NOT_PROTECT_AFFECTED | STAT_CHANGE_ALLOW_PTR, BattleScript_IntimidateLoopIncrement
	setgraphicalstatchangevalues
	jumpifability BS_TARGET, ABILITY_CONTRARY, BattleScript_IntimidateContrary
...
BattleScript_TimeManipulatorEffect_WaitString:
	waitmessage B_WAIT_TIME_LONG
	copybyte sBATTLER, gBattlerTarget
BattleScript_TimeManipulatorLoopIncrement:
	addbyte gBattlerTarget, 1
	jumpifbytenotequal gBattlerTarget, gBattlersCount, BattleScript_TimeManipulatorLoop
BattleScript_TimeManipulatorEnd:
	copybyte sBATTLER, gBattlerAttacker
	destroyabilitypopup
	pause B_WAIT_TIME_MED
	end3

BattleScript_TimeManipulatorPrevented:
	call BattleScript_AbilityPopUp
	pause B_WAIT_TIME_LONG
	setbyte gBattleCommunication STAT_SPEED
	stattextbuffer BS_TARGET
	printstring STRINGID_STATWASNOTLOWERED
	waitmessage B_WAIT_TIME_LONG
	goto BattleScript_TimeManipulatorLoopIncrement

BattleScript_TimeManipulatorContrary:
	call BattleScript_AbilityPopUpTarget
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_TimeManipulatorContrary_WontIncrease
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printfromtable gStatUpStringIds
	goto BattleScript_IntimidateEffect_WaitString
BattleScript_TimeManipulatorContrary_WontIncrease:
	printstring STRINGID_TARGETSTATWONTGOHIGHER
	goto BattleScript_TimeManipulatorEffect_WaitString
