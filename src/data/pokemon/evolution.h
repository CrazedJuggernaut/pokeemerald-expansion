const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GASTLY]                = {{EVO_LEVEL, 22, SPECIES_HAUNTER}},
...
#endif
    [SPECIES_CHANSEY]               = {{EVO_LEVEL, 45, SPECIES_BLISSEY}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_MIENFOO]               = {{EVO_LEVEL, 45, SPECIES_MIENSHAO}},
    [SPECIES_GOLETT]                = {{EVO_LEVEL, 43, SPECIES_GOLURK}},
    [SPECIES_PAWNIARD]              = {{EVO_LEVEL, 52, SPECIES_BISHARP}},
    [SPECIES_RUFFLET]               = {{EVO_LEVEL, 45, SPECIES_BRAVIARY},
                                       {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_BRAVIARY_HISUIAN}},
    [SPECIES_VULLABY]               = {{EVO_LEVEL, 45, SPECIES_MANDIBUZZ}},
    ...
    [SPECIES_BINACLE]               = {{EVO_LEVEL, 37, SPECIES_BARBARACLE}},
    ...
    [SPECIES_PHANTUMP]              = {{EVO_LEVEL, 33, SPECIES_TREVENANT},
                                       {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_LEVEL, 33, SPECIES_GOURGEIST},
    ...
    [SPECIES_NOIBAT]                = {{EVO_LEVEL, 44, SPECIES_NOIVERN}},
#endif
#if P_GEN_7_POKEMON == TRUE
    [SPECIES_ROWLET]                = {{EVO_LEVEL, 17, SPECIES_DARTRIX}},
    [SPECIES_DARTRIX]               = {{EVO_LEVEL, 34, SPECIES_DECIDUEYE},
                                       {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_DECIDUEYE_HISUIAN}},
    ...
    [SPECIES_TYPE_NULL]             = {{EVO_LEVEL, 39, SPECIES_SILVALLY}},
    ...
    [SPECIES_SNOM]                  = {{EVO_LEVEL, 31, SPECIES_FROSMOTH}},
...
#if P_GEN_8_POKEMON == TRUE
    [SPECIES_FARFETCHD_GALARIAN]    = {{EVO_CRITICAL_HITS, 1, SPECIES_SIRFETCHD}},
