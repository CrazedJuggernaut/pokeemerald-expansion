...
static const u8 sProwessDescription[] = _("KOs boost Sp. Atk stat.");
static const u8 sBrawlerDescription[] = _("Boosts contact moves.");
static const u8 sRoyalHoneyDescription[] = _("Restores HP every turn.");
static const u8 sMagicianDescription[] = _("Boosts Special moves, steals defenders item.");
static const u8 sAuraDescription[] = _("Boosts power in a pinch.");
static const u8 sRushdownDescription[] = _("Normal moves go first.");
static const u8 sApparitionDescription[] = _("Boosts evasion against physical attacks.");
static const u8 sParasitismDescription[] = _("boosts the power of HP-stealing moves.");
static const u8 sCirculateDescription[] = _("Turns Wind into HP.");
static const u8 sFormationDescription[] = _("Together they stand strong");
static const u8 sUnbreakableDescription[] = _("An unbreakable will");
static const u8 sSoulSiphonDescription[] =  _("Heal when defeating an enemy.");
static const u8 sPredatorDescription[] =  _("Heal when defeating an enemy.");
static const u8 sSageDescription[] =  _("Powers up Psychic moves");
...
static const u8 sKaktosDescription[]= _("Hurts to touch. Immune to water and sandstorm.");
static const u8 sBallisticsDescription[] = _("Boosts ball and bomb moves");
static const u8 sCleanseDescription[] = _("Grass moves against Poison.");
static const u8 sTheCreatorDescription[] = _("Boosts Normal type moves.");
static const u8 sRockBodyDescription[] = _("Restores HP every turn.");
static const u8 sAlloyBodyDescription[] = _("Halves weight. Weakens “supereffective”.");
static const u8 sFrigidBodyDescription[] = _("Allies resist fire. Immune to stat drops.");
static const u8 sInnerFlameDescription[] = _("Powers up if hit by fire.");
...
static const u8 sLorentzDescription[] = _("Levitates using electrically generated magnetism");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_ROYAL_HONEY] = _("Royal Honey"),
    [ABILITY_AURA] = _("Aura"),
    [ABILITY_RUSHDOWN] = _("Rushdown"),
    [ABILITY_APPARITION] = _("Apparition"),
    [ABILITY_PARASITISM] = _("Parasitism"),
    [ABILITY_CIRCULATE] = _("Circulate"),
    ...
    [ABILITY_KAKTOS] = _("Kaktos"),
    [ABILITY_BALLISTICS] = _("Ballistics"),
    [ABILITY_CLEANSE] = _("Cleanse"),
    [ABILITY_THE_CREATOR] = _("The Creator"),
    [ABILITY_ROCK_BODY] = _("Rock Body"),
    [ABILITY_ALLOY_BODY] = _("Alloy Body"),
    [ABILITY_FRIGID_BODY] = _("Frigid Body"),
    [ABILITY_INNER_FLAME] = _("Inner Flame"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_ROYAL_HONEY] = sRoyalHoneyDescription,
    [ABILITY_AURA] = sAuraDescription,
    [ABILITY_RUSHDOWN] = sRushdownDescription,
    [ABILITY_APPARITION] = sApparitionDescription,
    [ABILITY_PARASITISM] = sParasitismDescription,
    [ABILITY_CIRCULATE] = sCirculateDescription,
    ...
    [ABILITY_KAKTOS] = sKaktosDescription,
    [ABILITY_BALLISTICS] = sBallisticsDescription,
    [ABILITY_CLEANSE] = sCleanseDescription,
    [ABILITY_THE_CREATOR]= sTheCreatorDescription,
    [ABILITY_ROCK_BODY]= sRockBodyDescription,
    [ABILITY_ALLOY_BODY]= sAlloyBodyDescription,
    [ABILITY_FRIGID_BODY]= sFrigidBodyDescription,
    [ABILITY_INNER_FLAME] = sInnerFlameDescription,
    [ABILITY_INNER_SPARK] = sInnerSparkDescription,
    [ABILITY_INNER_WATER] = sInnerWaterDescription,
