...
const u32 gItemIcon_Snorlaxite[] = INCBIN_U32("graphics/items/icons/snorlaxite.4bpp.lz");
const u32 gItemIconPalette_Snorlaxite[] = INCBIN_U32("graphics/items/icon_palettes/snorlaxite.gbapal.lz");
