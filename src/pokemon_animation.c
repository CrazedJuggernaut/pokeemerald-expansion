...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_MILOTIC_MEGA]                 = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_BUTTERFREE_MEGA]              = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_MACHAMP_MEGA]                 = BACK_ANIM_V_SHAKE,
    [SPECIES_KINGLER_MEGA]                 = BACK_ANIM_V_SHAKE,
    [SPECIES_LAPRAS_MEGA]                  = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_FLYGON_MEGA]                  = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_KINGDRA_MEGA]                 = BACK_ANIM_SHAKE_GLOW_BLUE,
    ...
    [SPECIES_TYPHLOSION_MEGA]              = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_FERALIGATR_MEGA]              = BACK_ANIM_V_SHAKE,
