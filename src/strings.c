...
const u8 gText_BattleBagOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_BattleBagOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
...
const u8 gText_MenuPokedex[] = _("Pokeédex");
...
const u8 gText_SavingChampionMode[] = _("Champion Mode")
