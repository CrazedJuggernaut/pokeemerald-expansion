...
static const u8 sText_WillpowerEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} has two Abilities!");
static const u8 sText_BattlerAbilitySetUpGravity[] = _("{B_ACTIVE_NAME_WITH_PREFIX}'s Space Distortion\nset up Gravity!");
static const u8 sText_AngerPointsPkmnRaisedAttack[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s Anger Point\nraised its Attack!");
static const u8 sText_LunarGuardianEnters[] = _("{B_DEF_NAME_WITH_PREFIX} was cured\nof its sleep!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_EARLYBIRDENTERS - BATTLESTRINGS_TABLE_START] = sText_EarlyBirdEnters,
    [STRINGID_EARLYBIRDENDS - BATTLESTRINGS_TABLE_START] = sText_EarlyBirdEnds,
    [STRINGID_ATTACKERREGAINEDHEALTH - BATTLESTRINGS_TABLE_START] = sText_AttackerRegainedHealth,
    [STRINGID_WILLPOWERENTERS - BATTLESTRINGS_TABLE_START] = sText_WillpowerEnters,
    [STRINGID_SPACEDISTORTIONACTIVATED - BATTLESTRINGS_TABLE_START] = sText_BattlerAbilitySetUpGravity,
    [STRINGID_ANGERPOINTSPKMNRAISEDATTACK - BATTLESTRINGS_TABLE_START] = sText_AngerPointsPkmnRaisedAttack,
    [STRINGID_LUNARGUARDIANENTERS - BATTLESTRINGS_TABLE_START] = sText_LunarGuardianEnters,
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_EARLYBIRD] = STRINGID_EARLYBIRDENTERS,
    [B_MSG_SWITCHIN_WILLPOWER] = STRINGID_WILLPOWERENTERS,
    [B_MSG_SWITCHIN_LUNAR_GUARDIAN] = STRINGID_LUNARGUARDIANENTERS,
};
...
const u16 gWokeUpStringIds[] =
{
    ...
    [B_MSG_WOKE_UP_LUNAR_GUARDIAN] = STRING_ID_PKMNWOKEUPLUNARGUARDIAN
};
